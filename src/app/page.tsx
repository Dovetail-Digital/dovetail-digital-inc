...
export default async function Home() {
  ...
  try {
    ...
    const response = await fetch(
      `${process.env.STRAPI_SERVER}/api/landing-pages?filters[url][$eq]=/&populate[pageComponents][on][banners.logo-banner][populate]=logo.image&populate[pageComponents][on][banners.testimonials-banner][populate]=testimonials.profilePicture&populate[pageComponents][on][banners.card-banner][populate]=card.image&populate[pageComponents][on][banners.image-with-text][populate]=image&populate[pageComponents][on][banners.two-column-image][populate]=images&populate[pageComponents][on][banners.secondary-hero][populate]=image&populate[pageComponents][on][banners.hero-banner][populate]=heroImage&populate[pageComponents][on][banners.hero-banner][populate]=global&populate[pageComponents][on][banners.secondary-hero][populate]=global&populate[pageComponents][on][banners.two-column-image][populate]=global&populate[pageComponents][on][banners.logo-banner][populate]=global&populate[pageComponents][on][banners.card-banner][populate]=global&populate[pageComponents][on][banners.testimonials-banner][populate]=global&populate[pageComponents][on][banners.hero-banner][populate]=cta`
    );
